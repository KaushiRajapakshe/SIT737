...
3. Create a new branch named `sit737-2025-prac2p`. [Git Branch](https://github.com/KaushiRajapakshe/SIT737/tree/sit737-2025-prac2p)
4. Clone the repository to your local machine:
   ```bash
   git clone https://github.com/KaushiRajapakshe/SIT737.git
5. Swith to the branch in your local machine:
    ```bash
    git checkout sit737-2025-prac2p 
6. Navigate to the folder `sit737-2025-prac2p` and Run `npm install` command.
